...
You can get an example database of information about Stack Overflow questions and answers from [http://www.stat.berkeley.edu/share/paciorek/stackoverflow-2021.duckdb](http://www.stat.berkeley.edu/share/paciorek/stackoverflow-2021.duckdb). Stack Overflow is a website where programmers and software users can pose questions and get answers to technical problems.


```{r}
library(RSQLite)  # DBI is a dependency
dbfile <- file.path("..", "data", "stackoverflow-2021.duckdb")
db <- dbConnect(duckdb(), dbname = dbfile)  # This will vary depending on the back-end database
## stackoverflow-2021.db is an DuckDB database
